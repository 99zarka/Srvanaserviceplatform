...
const ProjectDetail = () => {
  ...
  const getProjectImage = () => {
    if (!selectedOrder) return "/FeaturedQuickServices-img/plumbing-leaks.webp";
    
    // Try to match by service name (English or Arabic)
    const serviceName = selectedOrder.service?.service_name || selectedOrder.service?.arabic_name;
