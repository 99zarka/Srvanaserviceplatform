...
const OfferCard = ({ offer, onAcceptOffer, loading, orderStatus }) => {
  ...
  const canAcceptOffer =
    (orderStatus === "AWAITING_CLIENT_ESCROW_CONFIRMATION" ||
      orderStatus === "OPEN") &&
      ...
      <CardContent className="p-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            >
              {offer.technician_user?.first_name}{" "}
              {offer.technician_user?.last_name}
            </Link>
          </div>
